                                ...
                                <View key={question.id} style={[styles.qaItem, { borderBottomColor: colors.border }]}>
                                    ...
                                    <View style={styles.qaHeader}>
                                        <Text style={[styles.qaAuthor, { color: colors.text }]}>
                                            {isVerified ? 'ご購入者様' : question.questioner?.name || '匿名'}
                                        </Text>
                                            ...
                                            {isExpanded ? (
                                                <View style={[styles.answerContainer, { backgroundColor: colors.surface }]}>
                                                    ...
                                                    <View style={styles.answerAvatarContainer}>
                                                        {question.answerer?.avatar ? (
                                                            <Image 
                                                                source={{ uri: question.answerer.avatar }} 
                                                                style={styles.answerImage}
                                                            />
                                                        ) : (
                                                            <View style={[styles.answerImagePlaceholder, { backgroundColor: colors.border }]}>
                                                                <Svg width={18} height={18} viewBox="0 0 24 24" fill="none">
                                                                    <Circle cx="12" cy="8" r="4" stroke={colors.textSecondary} strokeWidth="1.5" />
                                                                    <Path d="M6 21c0-3.314 2.686-6 6-6s6 2.686 6 6" stroke={colors.textSecondary} strokeWidth="1.5" strokeLinecap="round" />
                                                                </Svg>
                                                            </View>
                                                        )}
                                                    </View>
